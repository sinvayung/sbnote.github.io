...
![apk](assets/android_binder_8/apk_ui-20190312020025740.png)

界面上有三个按钮，分别是功能分别是bindService(绑定Service), unbindService(解除绑定Service), killProcess(杀死Service进程)。

从左往右，依次点击界面，可得：

![apk](assets/android_binder_8/logcat_BinderSimple-20190312020024874.png)

## 二、原理分析

调用图：

![aidl image](assets/android_binder_8/MyServer_java_binder-20190312020025473.jpg)
